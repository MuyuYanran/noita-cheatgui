...
_i18n = {
    ...
    translations = {
        en = {
            ...
            -- ====== Fog of War ======
            fog_title_status = "---- Status ----",
            fog_title_quick = "---- Quick Actions ----",
            fog_title_area = "---- Area Operations ----",
            fog_title_radius = "---- Explore Radius ----",
            fog_lbl_everywhere = "Whole map reveal: ",
            fog_lbl_at_player = "Visibility at player: %d/255 fog (%d%% visible)",
            fog_lbl_unknown = "Fog at player: unknown",
            fog_lbl_radius = "Explore radius: %d",
            fog_state_on = "ON",
            fog_state_off = "OFF",
            fog_btn_reveal_all = "Reveal All Map",
            fog_btn_restore_all = "Restore Fog",
            fog_btn_reveal_near = "Reveal Near",
            fog_btn_reveal_mid = "Reveal Mid",
            fog_btn_reveal_far = "Reveal Far",
            fog_btn_fog_near = "Fog Near",
            fog_btn_fog_far = "Fog Far",
            fog_btn_half_near = "Half Near",
            fog_btn_half_far = "Half Far",
            fog_btn_radius_256 = "r=256",
            fog_btn_radius_512 = "r=512",
            fog_btn_radius_1024 = "r=1024",
            fog_btn_radius_reset = "Reset",
            fog_btn_refresh = "Refresh",
            fog_err_no_world_state = "Cannot find WorldStateComponent",
            fog_err_no_radius_comp = "Player has no FogOfWarRadiusComponent",
            fog_err_set_fail = "Failed to set value",
            fog_log_everywhere_on = "Fog revealed everywhere (trailer mode ON)",
            fog_log_everywhere_off = "Fog restored (trailer mode OFF)",
            fog_log_area_set = "Area set: value=%d, range=%d, cells=%d",
            fog_log_area = "Area %s: range=%d, cells=%d",
            fog_action_clear = "cleared",
            fog_action_restore = "fogged",
            fog_action_set = "set=%d",
            fog_log_radius_set = "Explore radius set to: %d",
            ...
            -- ====== Console ======
            console_close_host = "[Stop Server]",
            console_open_host = "[Start Server]",
            console_open_browser = "[Open Browser]",
            console_copy_token = "[Copy Token]",
            console_separator = "---- Active Connections (click to kick) ----",
            console_conn_format = "%s [in: %d, out: %d]",
            console_conn_format_v2 = "%s [%s, in:%d out:%d]",
            console_server_running = "Server: RUNNING",
            console_server_starting = "Server: Starting...",
            console_server_stopped = "Server: Stopped",
            console_uptime = "Uptime: %s",
            console_ports = "WS: 9777 | HTTP: %d",
            console_token = "Token: %s",
            console_token_copied = "Token printed to game log (press F2 to view)",
            console_clients = "Clients: %d (%d authorized)",
            console_auth_yes = "auth",
            console_auth_no = "pending",
            console_no_clients = "No active connections",
        ...
        zh = {
            ...
            -- ====== Fog of War ======
            fog_title_status = "---- 当前状态 ----",
            fog_title_quick = "---- 快速操作 ----",
            fog_title_area = "---- 区域操作 ----",
            fog_title_radius = "---- 探索半径 ----",
            fog_lbl_everywhere = "全图揭示: ",
            fog_lbl_at_player = "玩家位置可见度: 迷雾%d/255 (%d%%可见)",
            fog_lbl_unknown = "玩家位置迷雾: 无法读取",
            fog_lbl_radius = "探索半径: %d",
            fog_state_on = "开启",
            fog_state_off = "关闭",
            fog_btn_reveal_all = "全图揭示",
            fog_btn_restore_all = "恢复迷雾",
            fog_btn_reveal_near = "揭示近处",
            fog_btn_reveal_mid = "揭示中等",
            fog_btn_reveal_far = "揭示远处",
            fog_btn_fog_near = "迷雾近处",
            fog_btn_fog_far = "迷雾远处",
            fog_btn_half_near = "半透明近",
            fog_btn_half_far = "半透明远",
            fog_btn_radius_256 = "半径=256",
            fog_btn_radius_512 = "半径=512",
            fog_btn_radius_1024 = "半径=1024",
            fog_btn_radius_reset = "重置",
            fog_btn_refresh = "刷新",
            fog_err_no_world_state = "无法找到 WorldStateComponent",
            fog_err_no_radius_comp = "玩家没有 FogOfWarRadiusComponent",
            fog_err_set_fail = "设置失败",
            fog_log_everywhere_on = "全图迷雾已揭示 (trailer 模式开启)",
            fog_log_everywhere_off = "迷雾已恢复 (trailer 模式关闭)",
            fog_log_area_set = "区域设置: 值=%d, 范围=%d, 格数=%d",
            fog_log_area = "区域%s: 范围=%d, 格数=%d",
            fog_action_clear = "已揭示",
            fog_action_restore = "已迷雾",
            fog_action_set = "值=%d",
            fog_log_radius_set = "探索半径设置为: %d",
            ...
            -- ====== Console ======
            console_close_host = "[停止服务]",
            console_open_host = "[启动服务]",
            console_open_browser = "[打开浏览器]",
            console_copy_token = "[复制 Token]",
            console_separator = "---- 活跃连接（点击踢出）----",
            console_conn_format = "%s [接收: %d, 发送: %d]",
            console_conn_format_v2 = "%s [%s, 收:%d 发:%d]",
            console_server_running = "服务器: 运行中",
            console_server_starting = "服务器: 启动中...",
            console_server_stopped = "服务器: 已停止",
            console_uptime = "运行时间: %s",
            console_ports = "WS: 9777 | HTTP: %d",
            console_token = "Token: %s",
            console_token_copied = "Token 已打印到游戏日志（按 F2 查看）",
            console_clients = "客户端: %d (%d 已认证)",
            console_auth_yes = "已认证",
            console_auth_no = "待认证",
            console_no_clients = "无活跃连接",
